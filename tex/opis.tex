...
Większość wykorzystanych modeli i tekstur została wykonana przez autora. Pozostałe zostały podarowane przez tech. Igora Samka, który udostepnił je na licencji CC-BY\cite{lic:ccby}. Tekstury i oprogramowanie dla materiału wchodzą w skład pakietu ,,Starter Content'' silnika Unreal Engine\cite{soft:ue4} i mogą być rozpowszechniane jako część aplikacji opartych na UE4, także w formie źródłowej.
