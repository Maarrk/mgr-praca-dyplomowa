...
\begin{todo}
    Zmienić sformułowania że system jest jakiś na to że jest tworzony --- podkreślić że nie jest produktem końcowym.

    Nadal z tekstu wynika że jest próba zastąpienia instruktora

    Dodać więcej o postępach w trakcie szkolenia, nie tylko ocena egzaminu.
\end{todo}
...
\begin{todo}
    Rysunek \ref{fig:definicjebledu} średnio czytelny

    Osie nie podpisane, kąt niejasno określony
\end{todo}
